			...
			<div className='flex flex-row justify-evenly'>
				...
				<div>
					...
					<ul className='flex items-center justify-center'>
						<li className='mx-2'>
							<a href={'https://www.facebook.com/papitaslike'} target='_blank' rel='noreferrer'>
								<FaFacebook />
							</a>
						</li>
						<li className='mx-2'>
							<a href={'https://www.youtube.com/watch?v=9-DMzDrl-2A&ab_channel=AgenciaMAS'} target='_blank' rel='noreferrer'>
								<FaYoutube />
							</a>
						</li>
					</ul>
